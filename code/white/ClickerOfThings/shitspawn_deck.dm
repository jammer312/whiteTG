/obj/item/jobanyj_rot
	...
	icon = 'code/white/ClickerOfThings/kazino.dmi'
	icon_state = "kazino"
...
/obj/item/toy/cards/deck/shitspawn_deck
	...
	w_class = WEIGHT_CLASS_SMALL
	throwforce = 1
	throwhitsound = 'code/white/ClickerOfThings/cardinsult.ogg'
...
/obj/item/toy/cards/deck/shitspawn_deck/attack_hand(mob/user)
	...
	H.pickup(user)
	user.put_in_hands(H)
	playsound(src, 'code/white/ClickerOfThings/pullcard.ogg', 50, 1)
...
/obj/item/toy/cards/deck/shitspawn_deck/attack_self(mob/user)
	if(cooldown < world.time - 50)
		...
		playsound(src, 'code/white/ClickerOfThings/cardshuffle2.ogg', 50, 1)
	...
	if(istype(I, /obj/item/toy/cards/singlecard))
		...
		if(SC.parentdeck == src)
			if(!user.temporarilyRemoveItemFromInventory(SC))
				...
				return
			cards += SC.cardname
			playsound(src, 'code/white/ClickerOfThings/diler_est.ogg', 50, 1)
			...
			playsound(src, 'code/white/ClickerOfThings/durak.ogg', 50, 1)
		...
		del(jobanyj_rot)
		playsound(src, 'code/white/ClickerOfThings/sluchai_v_kazino_full.ogg', 50, 1)
